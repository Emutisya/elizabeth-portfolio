...
const caseStudies = [
  {
    ...
    impact: [
      ...
      "Consolidated multiple approval paths into a single self-service flow",
      "Self-service experience adopted across partner engineering teams",
    ],
  ...
  },
  {
    ...
    impact: [
      ...
      "Closed compliance gaps with end-to-end governance visibility",
      "Standardized metadata schema adopted for all new permissions",
      "Streamlined audit readiness through centralized governance",
    ],
  ...
  },
  {
    ...
    impact: [
      ...
      "Established a repeatable, self-serve review model org-wide",
    ],
